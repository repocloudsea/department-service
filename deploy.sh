...
/usr/bin/sshpass -p 'voda*141#' scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o GSSAPIAuthentication=no -v department-service-0.0.1-SNAPSHOT.jar root@139.59.33.41:/root
